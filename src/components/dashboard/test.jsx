...
const DashboardTab = () => {
    return (
        <div className="flex flex-row">
            <nav
            className="md:w-1/3 left-side px-8 py-9 flex-col justify-between hidden md:flex md:py-8 md:px-7 xl:w-2/12"
            >
            <div>
                ...
                <div>
                    <p className="text-base font-bold text-gray-500">Redwhale</p>
                    <p className="text-xs font-bold text-slate-400">Growth & Marketing</p>
                </div>
                </div>
                <ul>
                <li className="mb-10">
                    ...
                    <span className="text-base font-semibold ml-3">Dashboard</span>
                    </a>
                </li>
                <li className="mb-10">
                    <a className="flex items-center">
            ...
            <section
            className="w-full p-4 bg-gray-50 md:w-2/3 md:p-8 md:min-content xl:w-7/12"
            >
            <div
                className="w-full flex justify-between items-start mb-8 space-x-3 overflow-x-scroll stories md:w-auto"
            >
                <div className="flex flex-col items-center">
                <div
                    className="w-14 h-14 block border-2 rounded-full mb-2 border-transparent relative"
                >
                    <img
            ...
            >
                ...
                <p className="text-base font-bold text-white opacity-30">VIEWS</p>
                <p className="text-base font-semibold text-white">7,482,120</p>
                </div>
                <div className="p-5 bg-[#4F46BA] rounded-xl w-full follows">
                <p className="text-base font-bold text-white opacity-30">FOLLOWS</p>
                <p className="text-base font-semibold text-white">54,364</p>
                </div>
                <div className="p-5 bg-[#4F46BA] rounded-xl w-full likes">
                <p className="text-base font-bold text-white opacity-30">LIKES</p>
                <p className="text-base font-semibold text-white">125,685</p>
                </div>
            </div>
            <div
                className="flex mb-8 flex-col items-center md:mb-14 xl:flex-row xl:items-start xl:space-x-4"
            >
                ...
                <div className="p-4 bg-white rounded-xl drop-shadow-md mb-4 xl:mb-10">
                    ...
                    <h3 className="text-sm font-bold mb-8 text-[#1B2767]">Daily Views</h3>
                    ...
                    <defs>
                        ...
                        >
                        <stop stopColor="#4CDFE8" fillOpacity="0.05" />
                        <stop offset="1" stopColor="#7947F7" fillOpacity="0.05" />
                        </linearGradient>
                        <linearGradient
                ...
                <div
                    className="flex flex-col space-y-4 mb-8 md:flex-row md:space-y-0 md:space-x-4 md:mb-14"
                >
                    <div
                    className="w-full p-4 bg-[#F2E9FF] rounded-xl drop-shadow-md h-1/2 md:w-2/4"
                    >
            ...
            <div
                className="flex flex-col items-center space-y-4 xl:flex-row xl:space-y-0 xl:space-x-4"
            >
                <div
                className="w-full py-4 px-8 bg-white rounded-xl drop-shadow-md flex items-center justify-between"
                >
                <div>
                ...
                <div
                className="w-full py-4 px-8 bg-[#51459E] rounded-xl drop-shadow-md flex items-center justify-between"
                >
                <div>
            ...
            <div className="flex justify-between items-center mb-16">
                ...
                <button
                    className="border-2 border-gray-200 rounded-xl p-2.5 relative btn-shadow"
                >
                    <svg
                    width="24"
                    height="24"
            ...
            <div className="flex flex-col items-center mt-3.5">
                ...
                <button
                    className="bg-[#4F46BA] py-4 px-7 rounded-xl text-white font-semibold"
                >
                    View Profile
                </button>
                <button
                    className="border-2 border-gray-200 rounded-xl py-4 px-7 text-[#11243D] font-semibold"
                >
                    Edit Profile
                </button>
                </div>
                <div
                className="flex w-full mt-0.5 justify-evenly items-center mb-8 space-x-4"
                >
                <div
                    className="bg-[#4F46BA]-350 pb-8 pl-4 pr-4 pt-16 rounded-xl relative w-1/2 h-48"
                >
                    <svg
                    width="42"
                    height="42"
                ...
                <div
                    className="bg-[#FEF3F0] pb-8 pl-4 pr-4 pt-16 rounded-xl relative w-1/2 h-48"
                >
                    <svg
                    width="42"
                    height="42"
